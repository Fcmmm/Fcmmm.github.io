...
function showWelcome() {
  ...
  document.getElementById("welcome-info").innerHTML = `<b><center>🎉 欢迎信息 🎉</center>&emsp;&emsp;欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里，当前的IP地址为： <span style="color:var(--theme-color)">${ip}</span>， ${posdesc}<br><span style="color:var(--theme-color)">欢迎在“社交”->“留言板”中留言喔！</span></br>`;;
...
function createtime1() {
  var grt = new Date("04/08/2025 12:00:00"); //此处修改你的建站时间或者网站上线时间
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://img.picui.cn/free/2025/04/09/67f5cea8ce6de.jpg);
    --darkmode-bg:url(https://img.picui.cn/free/2025/04/13/67fb66a81276e.webp);
    --mobileday-bg: url(https://img.picui.cn/free/2025/04/16/67ff0cfd5ce9a.webp);
    --mobilenight-bg: url(https://img.picui.cn/free/2025/04/16/67ff0cff818c4.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
